...
console.log('');
console.log('🔧 生成 .icns 文件需要：');
console.log('   - 安装 iconutil (macOS 自带)');
console.log('   - 准备 1024x1024 PNG 图标');
console.log('   - 运行: mkdir -p icon.iconset && sips -z 16 16 icon.png --out icon.iconset/icon_16x16.png');
console.log('   - 运行: iconutil -c icns icon.iconset');
